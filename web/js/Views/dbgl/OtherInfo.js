...
define(function(){
    ...
    function render(parameters){
        ...
        $("#otherinfo").ligerForm({
            ...
            fields: [
                { display: "测试1", name: "ces", newline: true,  type: "text",group:"家庭财产信息" },
                ...
                { display: "测试1", name: "ces", newline: true,  type: "text",group:"个人收入信息" },
                { display: "测试2", name: "ces2", newline: false,  type: "text" },
                { display: "测试3", name: "ces3", newline: true,  type: "text" },
                { display: "测试4", name: "ces4", newline: false,  type: "text" },
                { display: "测试5", name: "ces5", newline: true,  type: "text" },
                { display: "测试6", name: "ces6", newline: false,  type: "text" },
                { display: "测试1", name: "ces", newline: true,  type: "text",group:"审批信息" },
                { display: "测试2", name: "ces2", newline: false,  type: "text" },
                { display: "测试3", name: "ces3", newline: true,  type: "text" },
                { display: "测试4", name: "ces4", newline: false,  type: "text" },
                { display: "测试5", name: "ces5", newline: true,  type: "text" },
                { display: "测试6", name: "ces6", newline: false,  type: "text" },
                { display: "测试6", name: "ces6", newline: true,  type: "textarea",width:600 }
            ]/*,
